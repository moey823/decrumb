...
The signed feed is `build/Decrumb-1.1.1-8-arm64-appcast.xml`, deployed unchanged
to [the stable feed](https://mkships.app/decrumb/appcast.xml) by mkships commit
`cdeec424bab41c0f8ad7b84739cc2ab9d3d85dc1`.
...
- The live feed advertises 1.1.1/build 8 and matches the signed artifact byte for
