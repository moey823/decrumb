...
- Keep account keys, pairing images, messages, logs, configuration and runtime databases outside Git. Runtime files belong in `~/Library/Application Support/Decrumb`, outside the source checkout and app bundle.
